...
if [ -z $1 ] || [ -z $2 ]; then
echo "Usage: ./lucie_start_mapping.sh name_of_topological_map path_to_home_directory";
exit;
fi
...
mkdir -p $2/robot_files;
mkdir -p $2/mongodb_store/$1;
fi
...
ROBOT_FILES=$2/robot_files
DATABASE=$2/mongodb_store/$1
